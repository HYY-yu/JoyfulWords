  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <Button
          type="submit"
          className="w-full h-12 bg-[#635BFF] hover:bg-[#4B45BC] text-white font-bold text-base"
          disabled={loading}
          style={{
            backgroundColor: loading ? undefined : '#635BFF',
          }}
        >
          {loading ? (
            <>
            ...
            t('billing.payment.form.payWithStripe')
          )}
        </Button>
        ...
        <p className="text-xs text-center text-muted-foreground">
          ...
          {t('billing.payment.form.stripeSecure')}
        </p>
      </form>
    </Form>
  )
