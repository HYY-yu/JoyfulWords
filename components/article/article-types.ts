...
//
// TODO: 后端 API 集成后废弃 Mock 数据
// 参考：docs/tiptap/editor_features.md 阶段1 任务1.1
// API endpoints:
...
export const mockArticles: Article[] = [
  {
    ...
    content: `<p>人工智能技术正在深刻改变内容创作的方式和效率。从自动化写作到智能编辑，AI工具为创作者提供了强大的支持。本文将深入探讨AI在内容创作领域的应用现状，分析主流AI创作工具的特点，并展望未来发展趋势。</p><p>我们将重点关注自然语言处理、图像生成、视频制作等领域的AI应用，以及这些技术如何帮助创作者提高工作效率、改善内容质量。同时，我们也会讨论AI创作带来的挑战和伦理问题，为内容创作者提供全面的参考。</p>`,
  ...
  },
  {
    ...
    content: `<p>在当今数字化时代，社交媒体营销已成为品牌推广的核心策略。如何在海量内容中脱颖而出，打造真正吸引用户的爆款内容？本文将分享实用的社交媒体营销策略，包括内容策划、用户画像分析、发布时机选择、互动技巧等关键要素。</p><p>我们将结合成功案例，详细解析抖音、小红书、微博等主流平台的内容创作技巧，帮助营销人员制定有效的社交媒体策略，提升品牌影响力和用户参与度。</p>`,
  ...
  },
  {
    ...
    content: `<p>个人品牌在职业发展中扮演着越来越重要的角色。如何建立和维护个人品牌，提升在行业内的影响力？本文将从个人定位、内容输出、社交网络构建、口碑管理等方面，系统介绍个人品牌建设的策略和方法。</p><p>通过实际案例，我们将展示不同领域的专业人士如何通过持续的价值输出和有效的社交策略，建立起独特的个人品牌，实现职业发展的突破。无论你是创业者、自由职业者还是职场人士，都能从中获得实用的建议。</p>`,
  ...
  },
  {
    ...
    content: `<p>短视频已成为最受欢迎的内容形式之一。如何创作出引人入胜的短视频内容？本文将详细介绍短视频创作的完整流程，从创意构思、脚本撰写、拍摄技巧到后期制作和发布策略。</p><p>我们将分享实用的拍摄设备推荐、剪辑软件使用技巧、音乐选择要点，以及各大平台的内容推荐机制分析。无论你是短视频创作新手还是希望提升内容质量，都能找到有价值的指导。</p>`,
  ...
  },
  {
    ...
    content: `<p>内容创作者经常面临多任务并行的挑战，如何有效管理时间，提高创作效率？本文将分享专门针对创作者的时间管理技巧，包括内容规划、批量创作、工具使用、精力管理等方面。</p><p>我们将介绍实用的番茄工作法变种、内容日历制定方法、自动化工具推荐，以及如何克服创作瓶颈和拖延症。通过合理的时间管理，创作者可以在保证内容质量的同时，提高产出效率，实现更好的工作生活平衡。</p>`,
  ...
  },
  {
    ...
    content: `<p>知识付费已成为内容创作者重要的变现方式。如何开发受欢迎的知识付费产品？本文将系统介绍知识付费产品的开发流程，包括市场调研、选题策划、内容设计、产品制作、营销推广等关键环节。</p><p>我们将分析在线课程、电子书、付费专栏、咨询服务等不同类型知识付费产品的特点，分享定价策略、用户获取、留存转化等实战经验。通过成功案例分析，帮助创作者找到适合自己的知识付费模式。</p>`,
  ...
  },
  {
    ...
    content: `<p>直播带货已成为电商的重要形式，如何在激烈的竞争中脱颖而出？本文将分享直播带货的实用技巧，包括主播培养、话术设计、产品展示、互动技巧、流量获取等方面。</p><p>我们将分析成功直播带货案例，总结提高转化率的关键要素，包括如何建立信任感、制造稀缺性、处理异议等。同时介绍直播设备选择、场景布置、技术准备等实操要点，帮助主播提升直播效果和销售业绩。</p>`,
  ...
  },
  {
    ...
    content: `<p>搜索引擎优化是获取自然流量的重要手段。如何系统性地进行SEO优化，提升网站排名？本文将从关键词研究、网站结构优化、内容优化、技术SEO、外链建设等方面，详细介绍SEO的最佳实践。</p><p>我们将分享实用的SEO工具使用技巧，包括Google Analytics、Search Console、Ahrefs等工具的数据分析和优化建议。通过案例分析和实战经验，帮助网站运营者制定有效的SEO策略，提高搜索引擎排名和流量。</p>`,
  ...
  },
  {
    ...
    content: `<p>内容创作过程中存在各种法律风险，如何有效防范？本文将介绍创作者需要了解的法律知识，包括版权保护、肖像权、名誉权、广告法合规等方面。</p><p>我们将分析常见侵权案例，讲解如何正确使用图片、音乐、视频等素材，避免法律纠纷。同时介绍内容合规要点，包括广告标识、虚假宣传、个人信息保护等注意事项。通过法律风险防范，创作者可以安心创作，避免不必要的法律麻烦。</p>`,
  ...
  },
  {
    ...
    content: `<p>元宇宙作为新兴的数字领域，为内容创作者带来了新的机遇。如何在元宇宙环境中进行内容创作？本文将探讨元宇宙内容创作的特点和可能性，包括虚拟世界构建、3D内容制作、交互体验设计等方面。</p><p>我们将分析当前主流元宇宙平台的内容生态，分享VR/AR内容创作工具和技巧，讨论元宇宙内容变现模式。虽然元宇宙仍处于发展初期，但提前布局这一领域的创作者将有机会抢占先机。</p>`,
  ...
  },
  {
    ...
    content: `<p>播客作为音频内容的重要形式，正在快速发展。如何制作高质量的播客节目？本文将从设备选择、录音技巧、后期制作、节目策划等方面，详细介绍播客制作的完整流程。</p><p>我们将推荐不同预算的录音设备配置，分享声音处理和降噪技巧，介绍常用的音频编辑软件。同时讨论播客内容规划、嘉宾邀请、听众互动等运营策略，帮助播客创作者建立稳定的节目体系和听众群体。</p>`,
  ...
  },
  {
    ...
    content: `<p>创作者经济正在崛起，如何建立多元化的收入模式？本文将探讨创作者的各种变现方式，包括广告收入、付费内容、赞助合作、周边产品、线下活动等。</p><p>我们将分析不同收入模式的特点和适用场景，分享成功案例和经验教训。同时讨论如何平衡内容质量和商业变现，如何建立可持续的商业模式，帮助创作者实现长期稳定的收入增长，摆脱对单一收入来源的依赖。</p>`,
