...
1. Generate 3 to 5 cover options.
2. Pick one visual direction.
3. Generate inline visuals with the same style anchors.
4. Create one shareable card from the article's strongest paragraph.
...
1. Select one paragraph with clear value.
2. Ask AI to extract the key point and supporting bullets.
