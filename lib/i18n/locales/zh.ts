    ...
    presentationV2: {
        ...
        generation: {
            ...
            stage: {
                queued: "等待生成",
                preparing: "准备生成",
                matching_templates: "匹配模板",
                selecting_pages: "选择页面",
                filling_deck_input: "填充内容",
                validating_input: "校验内容",
                resolving_assets: "解析素材",
                generating_pptx: "生成 PPTX",
                verifying_pptx: "校验 PPTX",
                uploading: "上传文件",
                succeeded: "生成完成",
                failed: "生成失败",
            },
