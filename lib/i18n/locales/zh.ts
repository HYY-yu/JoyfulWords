export const zh = {
    ...
    echarts: {
        ...
        dialog: {
            ...
            maxCharts: "最多图表数",
            displayPreset: "默认展示",
            displayPresetLegend: "开启图例",
            displayPresetTooltip: "开启提示框",
            displayPresetGrid: "开启网格线",
            generateAndInsert: "生成并插入",
            generateFromArticle: "分析整篇文章",
            generatingTitle: "图表生成中",
