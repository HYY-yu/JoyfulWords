export const en = {
    ...
    contentWriting: {
        ...
        aiHelp: {
            ...
            overwriteConfirmTitle: "Replace the current article?",
            overwriteConfirm: "The generated content will replace the entire body of this article and cannot be undone. Continue?",
            overwriteConfirmAction: "Continue",
        ...
        taskCenter: {
            ...
            clearFinishedConfirm: "This removes all completed and failed task records (generated content is not affected) and cannot be undone. Continue?",
            ...
            taskTitles: {
                ...
                presentation: "PPT Generation Job",
                echarts: "AI Chart Job",
                podcast: "Podcast Script Job",
                podcastAudio: "Podcast Audio Job",
            },
            taskSummaries: {
                presentationSlideCount: "{count} slides",
                podcastAudioSegments: "{completed}/{total} audio segments generated",
            },
            fields: {
                execId: "Execution ID",
                scriptId: "Script ID",
                audioTaskId: "Audio Task ID",
                ...
                storycardVersion: "Storycard Version",
                ...
                verifyPassed: "PPTX Verification Passed",
                verifyErrors: "PPTX Verification Errors",
                pptUrl: "PPTX URL",
            ...
            verifyPassed: "PPTX structure verification passed",
        ...
        materialPanel: {
            ...
            clueBoardExpandFailed: "Failed to expand this clue. Please try again.",
            ...
            openImage: "Open",
            aiImageEntryTitle: "No suitable image?",
            aiImageEntryDescription: "Generate one with AI and save it to materials.",
            aiImageEntryAction: "Generate image",
            ...
            importPartialSuccess: "Some materials were added",
            importPartialSuccessDescription: "{success} succeeded and {failed} failed: {urls}",
            importFailed: "Failed to add materials",
            importWorkerFailed: "Background import failed. Please try again.",
    ...
    imageGeneration: {
        ...
        cover: {
            ...
            titleOptimizeConfirm: "This title is quite long and may not fit the cover layout. Click OK to let AI shorten it (the article title will be updated too), or Cancel to keep the current title.",
            ...
            resourcesLoading: "Loading cover resources…",
            toast: {
                ...
                resourcesNotReady: "Cover resources are still loading. Please save again when ready.",
...
| Paying customers | 420 | +12% |`,
        page: {
            ...
            toolboxMarkdownDescription: "Paste Markdown, choose a Word template, and generate an editable document.",
            toolboxMarkdownTitle: "Markdown to Word",
            toolboxPptDescription: "Upload a PPTX file and convert its titles, key points, and notes into Word.",
            toolboxPptTitle: "PPT to Word",
        },
        access: {
            authChecking: "Checking session",
            guestQuota: "Guest mode · Uses guest quota",
            signedIn: "Signed in",
        },
        guest: {
            templateLoginTitle: "Sign in to upload personal templates",
            templateLoginDescription: "Guests can use the system default and public templates.",
            login: "Sign in",
            resultHint: "Guest results stay with this browser's guest session. Download the file before leaving.",
        },
        modes: {
        ...
        errors: {
            ...
            guestQuotaExceeded: "Today's guest trial quota is used up. Sign in to continue.",
    ...
    tiptapEditor: {
        ...
        imageMenu: {
            ...
            styleListTitle: "Select Image Style",
            styleListDescription: "Choosing a style creates an image stylization task immediately.",
            loadingStyles: "Loading styles...",
            loadStylesFailed: "Failed to load styles",
            retry: "Retry",
            noStyles: "No styles available",
            customStyle: "Custom Style",
            customTitle: "Custom Image Style",
            customDescription: "Describe the style to create an image stylization task.",
            customPlaceholder: "Example: watercolor illustration, soft colors, preserve the subject structure...",
            customCancel: "Cancel",
            customSubmit: "Create Task",
            customRequired: "Enter a custom style description",
            noImageSource: "Current image URL was not found",
            taskCreated: "Image stylization task created",
            taskCreateFailed: "Failed to create image stylization task",
            inpaint: "Local Repaint",
            inpaintTitle: "Local Repaint",
            inpaintSubtitle: "Paint translucent marks over the areas to repaint.",
            inpaintModel: "Model",
            inpaintLoadingModels: "Loading models",
            inpaintTool: "Tool",
            inpaintPan: "Pan",
            inpaintBrush: "Brush",
            inpaintErase: "Eraser",
            inpaintBrushSize: "Brush size",
            inpaintStrokeList: "Stroke list",
            inpaintStrokeListEmpty: "No strokes yet",
            inpaintStrokeLabel: "Stroke label",
            inpaintRemoveStroke: "Remove stroke",
            inpaintStrokeDefaultLabel: "Stroke",
            inpaintUndo: "Undo",
            inpaintReset: "Reset",
            inpaintClear: "Clear strokes",
            inpaintConfirm: "Confirm and generate",
            inpaintNoMarks: "Mark an area on this image first",
            inpaintUploading: "Uploading marked image...",
            inpaintGenerating: "Generating image...",
            inpaintReady: "Generation complete. Continue repainting or write back to the editor.",
            inpaintGenerated: "Local repaint image generated",
            inpaintFailed: "Local repaint failed",
            inpaintImageLoadFailed: "Failed to load image",
            inpaintLoadingImage: "Loading image",
            inpaintZoomHint: "Reset the view to continue editing",
            inpaintReplace: "Replace Original",
            inpaintInsert: "Insert Image",
            inpaintInserted: "Inserted image",
            inpaintReplaced: "Replaced original image",
            inpaintInsertFailed: "Failed to insert image",
            inpaintReplaceFailed: "Failed to replace image",
            inpaintInsertedAlt: "Local repaint generated image",
        },
        aiPanel: {
            title: "AI Features",
            ...
            groupDescriptions: {
                ...
                structure: "Turn article content into mind maps, podcast audio, slides, or Word documents.",
            },
            aiEdit: "AI Edit",
            aiWrite: "AI Write",
            mindmap: "AI Mind Map",
            ...
            saveArticleFirst: "Save the article first to use this",
    ...
    podcastAudioDialog: {
        title: "Article to Podcast Audio",
        description: "Generate a reviewable podcast script first, then create segment audio for sequential playback.",
        saveArticleFirst: "Save the article before generating podcast audio.",
        settingsTitle: "Podcast Settings",
        podcastTypeLabel: "Podcast type",
        languageLabel: "Language",
        voiceSelectPlaceholder: "Select voice",
        voiceLoadFailed: "Failed to load voices. Please try again later.",
        previewVoice: "Preview voice",
        generateScript: "Generate Script",
        regenerateScript: "Regenerate Script",
        saveScriptText: "Save Script Text",
        generateAudio: "Generate Audio",
        regenerateAudio: "Regenerate Audio",
        downloadFullAudio: "Download Full Audio",
        downloadMergedAudio: "Download WAV Audio",
        mergeAudio: "Merging Audio",
        mergeProgress: "Merging {completed}/{total} audio segments",
        mergeFailed: "Audio merge failed. Make sure every segment has finished, then try again.",
        mergeUnavailable: "Some audio segments are not complete yet. Full audio download is unavailable.",
        footerMeta: "{participants} participant(s) · {segments} script segments · {duration} estimated · {audioSegments} audio segments ready",
        loadingLatest: "Loading latest script...",
        scriptPreviewEyebrow: "Podcast Script",
        scriptEmptyTitle: "No podcast script yet",
        scriptEmptyDescription: "Generate a podcast script to preview the title, summary, participants, and segment lines here.",
        scriptReadonlyHint: "Title and summary are read-only. Edit segment lines, then regenerate audio after saving.",
        segmentTextLabel: "Line text",
        participantsLabel: "Participants",
        segmentsLabel: "Script segments",
        estimatedDurationLabel: "Estimated duration",
        playerEyebrow: "Audio Player",
        playerEmptyTitle: "Waiting for audio",
        audioSegmentsTitle: "Audio Segments",
        segmentGenerating: "Generating this segment...",
        segmentRegenerating: "Regenerating this segment...",
        audioGeneratingEmpty: "Audio is generating. Completed segments will appear here.",
        audioEmptyDescription: "After the script succeeds, generate audio to get playable segment files.",
        steps: {
        ...
        podcastTypes: {
            ...
            two_person_interview: "Two-person Interview",
        },
        languages: {
            auto: "Auto",
            "zh-CN": "Chinese",
        ...
        toast: {
            playFailed: "Playback failed. Check the audio URL or browser permissions.",
            scriptSaved: "Script text saved",
            scriptSavedNoAudioDesc: "There is no completed audio segment to regenerate yet.",
            scriptSavedSegmentAudioDesc: "This segment audio is regenerating automatically.",
            scriptSavedSegmentAudioFailedDesc: "Automatic segment regeneration failed. Use the right-side button to rebuild full audio.",
            voicePreviewFailed: "Voice preview failed. Please try again later.",
            voicePreviewFailedDesc: "Change the voice or language, then try again.",
        },
    },
    wechatExport: {
        title: "WeChat Official Account Export",
        description: "Convert the current article into rich text that can be pasted into the WeChat editor.",
        copy: "Copy",
        copied: "Copied",
        empty: "There is no article content to export yet",
        meta: "{words} characters · about {minutes} min read",
        controls: {
            theme: "Theme",
        ...
        toast: {
            copySuccess: "Copied as WeChat rich text",
            copySuccessDesc: "Paste it directly into the WeChat Official Account editor.",
            copyFailed: "Copy failed",
            copyFailedDesc: "The browser clipboard is unavailable. Retry or check permissions.",
        },
        hooks: {
            title: "Opening Hooks",
            subtitle: "Summarize the article and generate 7 WeChat opening candidates.",
            generate: "Generate Summary",
            generating: "Generating...",
            summary: "Summary under 120 characters",
            copy: "Copy hook",
            copySuccess: "Hook copied",
            copyFailed: "Failed to copy hook",
            toastSuccess: "Summary and hooks generated",
            toastFailed: "Generation failed",
            toastFailedDesc: "Retry later or check your credit balance.",
            types: {
                hook_1: "Counter-consensus assertion",
                hook_2: "Real data shock",
                hook_3: "Personal story opening",
                hook_4: "Question hook",
                hook_5: "Scene immersion",
                hook_6: "Pain-point hit",
                hook_7: "Contrast hook",
            },
        },
    },
    echarts: {
        ...
        dialog: {
            ...
            selectionSubmittedTitle: "AI chart task created",
            selectionSubmittedDescription: "The chart is generating in the background. Track it in Task Center, then adjust the style and insert it into the article.",
            ...
            analysisQueuedTitle: "Article analysis task created",
            analysisQueuedDescription: "Chart suggestions are being extracted in the background and will sync to Task Progress automatically.",
            ...
            analysisFailedTitle: "Article analysis failed",
            analysisFailedDescription: "The article analysis could not be completed. Try again later.",
            analysisTimeoutDescription: "Article analysis timed out. Check Task Progress later or submit it again.",
    ...
    presentationV2: {
        title: "Generate PPT",
        description: "Review the content structure, choose a template, and generate an editable PowerPoint.",
        loading: "Restoring your presentation progress",
        back: "Back",
        languages: {
            zh: "Chinese",
            en: "English",
        ...
        storycard: {
            ...
            startDescription: "We will turn the article into an editable presentation structure. Review it before choosing a template.",
            generatingTitle: "Building the Storycard",
            generatingDescription: "Analyzing the article structure, section relationships, and slide content. This may take a few minutes.",
            failedTitle: "Storycard generation failed",
            failedDescription: "You can submit the request again. Your article will not be changed.",
            ...
            overviewDescription: "These fields define the audience, objective, and narrative direction.",
            ...
            contentPointsHint: "One point per line",
            logicRelations: "Recommended logic",
            logicRelationsHint: "Selection order sets the template-matching priority. Choose up to three.",
            sourceRefs: "Source references",
            noSourceRefs: "No source references",
            save: "Save Storycard",
            confirm: "Confirm and choose template",
            unsaved: "You have unsaved changes",
            saved: "Storycard saved",
            closeConfirm: "The Storycard has unsaved changes. Close anyway?",
        },
        template: {
        ...
        generation: {
            ...
            failedTitle: "PPT generation failed",
            progressLabel: "PPT generation stages",
            retry: "Retry generation",
            editStorycard: "Edit Storycard",
            jobId: "Job ID",
            slideCount: "Slides",
            generatedImageCount: "AI images",
            statusLabel: "Status",
            status: {
                queued: "Queued",
                processing: "Processing",
            ...
            stage: {
                ...
                cataloging_images: "Checking article images",
                planning_images: "Planning presentation images",
                generating_images: "Generating presentation images",
                matching_templates: "Analyzing slide structure",
                selecting_pages: "Matching template slides",
                filling_deck_input: "Composing presentation content",
                validating_input: "Validating content",
                resolving_assets: "Preparing images and icons",
                generating_pptx: "Generating PowerPoint",
                verifying_pptx: "Verifying presentation",
                uploading: "Uploading file",
                succeeded: "Presentation ready",
                failed: "Generation failed",
            },
            stageProgress: "Stage {current} of {total}",
        },
        taskCenter: {
            continueInArticle: "Continue in article",
        },
        complete: {
            title: "Presentation ready",
            description: "Generated {count} slides. Download the deck to continue editing in PowerPoint.",
            download: "Download PPTX",
        },
        validation: {
            firstSlideCover: "The first slide must be a cover.",
            lastSlideEnding: "The last slide must be a closing slide.",
            exactlyOneAgenda: "The Storycard must contain exactly one agenda slide.",
            agendaBeforeSections: "The agenda must appear before section slides.",
            sectionCount: "The Storycard must contain 3–6 section slides.",
            agendaPointCount: "Agenda points must match the number of sections.",
            contentSlideRequired: "At least one content slide is required.",
            slideTitleRequired: "The slide title is required.",
            slideKeyMessageRequired: "The key message is required.",
            invalidPageType: "The slide type is not valid for this Storycard contract.",
            logicRelationsRequired: "Content slides require recommended logic relations.",
            logicRelationsCount: "Choose one to three recommended logic relations.",
            logicRelationInvalid: "One or more logic relations are not supported.",
            logicRelationDuplicate: "Recommended logic relations cannot be duplicated.",
            logicRelationsContentOnly: "Recommended logic relations are only allowed on content slides.",
        },
        toast: {
            generateSubmitted: "Storycard generation started",
            generateFailed: "Failed to start Storycard generation",
            saved: "Storycard saved",
            confirmed: "Storycard confirmed",
            versionConflict: "The Storycard changed. The latest version has been loaded.",
            generationSubmitted: "PPT generation job created",
            retrySubmitted: "PPT job queued again",
        },
        errors: {
            saveArticleFirst: "Save the article before generating a PPT.",
            ...
            versionConflict: "The Storycard changed elsewhere. The latest version is now loaded; review it and retry.",
            saveStorycard: "Unable to save the Storycard. Try again later.",
            confirmStorycard: "Unable to confirm the Storycard. Try again later.",
            createGeneration: "Unable to create the PPT job. Try again later.",
            retryGeneration: "Unable to retry the PPT job. Try again later.",
            download: "The PPTX download is not ready. Try again shortly.",
            generationMissing: "No presentation generation job could be restored.",
            generation: {
                dependency_unavailable: "The generation service is temporarily unavailable. Try again later.",
                invalid_storycard_snapshot: "The Storycard snapshot is invalid. Return to the article and confirm it again.",
                invalid_template_snapshot: "The template snapshot is invalid. Choose the template again.",
                invalid_runtime_manifest: "The PPT runtime configuration is invalid. Try again later.",
                article_not_found: "The source article could not be found.",
                image_catalog_failed: "Article images could not be prepared. Try again later.",
                image_generation_failed: "Presentation image generation failed. Try again later.",
                template_match_failed: "This Storycard could not be matched to the template. Adjust its structure and retry.",
                selected_pages_encode_failed: "Template slide data could not be processed. Try again later.",
                deck_fill_failed: "Presentation content could not be composed. Adjust the Storycard and retry.",
                deck_encode_failed: "Presentation content data could not be processed. Try again later.",
                asset_resolution_failed: "Images or icons could not be prepared. Try again later.",
                template_download_failed: "The template could not be downloaded. Try again later.",
                template_checksum_mismatch: "Template version verification failed. Try again later.",
                runtime_failed: "PowerPoint generation failed. Try again later.",
                runtime_output_invalid: "The generated PowerPoint file is invalid. Try again later.",
                upload_failed: "The PPTX upload failed. Try again later.",
                submit_failed: "The generation job could not be submitted. Try again later.",
                unknown: "PPT generation failed. Try again later.",
            },
        },
    },
    infographicDialog: {
        ...
        selectedTextPlaceholder: "Edit this content directly before generating the infographic.",
        selectedTextCount: "{count}/{limit} chars",
        selectedTextHint: "The infographic will use the content here. Keep it under {limit} characters; edit it directly before submitting.",
        selectedTextTooLongHint: "The current content has {count} characters, above the {limit}-character limit. Shorten the text or switch to full article analysis.",
        ...
        regenerate: "Regenerate",
        regenerateFromArticle: "Reanalyze Full Article",
        generating: "Generating...",
        ...
        restoringPreviousResult: "Restoring the latest infographic result for this article.",
        restoringPreviousResultTitle: "Restoring Previous Result",
        restoringPreviousResultDesc: "Loading the latest successful result without creating a new task.",
        restoredPreviousResult: "The latest infographic result was restored. Regenerate if you want a new version.",
        addToMaterials: "Add To Materials",
        ...
        toast: {
            selectTextFirst: "Please enter text first",
            selectTextFirstDesc: "Infographics need the text content in this field.",
            selectionTooLong: "Text is too long",
    ...
    aiRewrite: {
        ...
        finishMarkdownEditing: "Finish editing and preview",
    ...
    landing: {
        ...
        badge: "AI Content Creation Workspace",
        heading: "One idea creates",
        headingAccent: "articles, infographics,",
        headingAccentSuffix: "decks, and mind maps",
        description: "JoyfulWords finds source material, builds your draft, then turns it into an infographic, presentation, and mind map in one workflow.",
        cta: "Start free · Get 200 credits",
        watchDemo: "Watch the 60-second demo",
        stats: {
            subscription: {
                value: "$0",
                label: "Subscription fee, pay as you go",
            },
            workflow: {
                value: "4 + 1",
                label: "4 creation tools, 1 workflow",
            },
            credit: {
                value: "Usage-based",
                label: "Credits scale with content complexity",
            },
        },
        media: {
            heroLabel: "Overview of four JoyfulWords content outputs",
            heroPosterAlt: "JoyfulWords content workflow preview",
            heroCaption: "Start with one topic and create four content formats in one workflow.",
            exploreFeatures: "Explore all four tools",
        },
        howItWorks: {
            eyebrow: "How it works",
            title: "From idea to publish in four steps",
            description: "Research, outline, drafting, and multi-format export happen on one page, without moving content between tools.",
            steps: {
                research: {
                    title: "Find source material",
                    description: "Search the web in real time and save useful links and ideas in seconds.",
                },
                outline: {
                    title: "Shape the outline",
                    description: "AI extracts the key points and gives your article a clear structure.",
                },
                draft: {
                    title: "Generate the draft",
                    description: "Submit an AI writing request, let the task build a full draft, then continue refining it in the editor.",
                },
                export: {
                    title: "Export every format",
                    description: "Your article, infographic, presentation, and mind map are ready.",
                },
            },
        },
        featuresHeading: "Four creation tools, ",
        featuresHeadingAccent: "all built in",
        featuresSubheading: "One source connects four formats. Articles, infographics, and mind maps work together now; PPT shows a preview of the implemented code flow.",
        features: {
            article: {
                eyebrow: "AI Writing",
                title: "Generate articles faster",
                description: "Start with a topic and generate a structured outline, full draft, and visual direction, with rewriting and tone controls built in.",
                point1: "Describe the writing task and choose a style",
                point2: "Track the task from initializing to draft",
                point3: "Open the three-column editor to refine the result",
                cta: "Try AI writing",
                mediaLabel: "Article generation demo",
                posterAlt: "JoyfulWords AI article writing workspace",
            },
            infographic: {
                eyebrow: "Infographic",
                title: "Generate infographics",
                description: "Turn key points into a shareable visual for article summaries, data storytelling, and social distribution.",
                point1: "Arrange key points into a clear visual",
                point2: "Switch between multiple visual styles",
                point3: "Configure orientation, language, and content density",
                cta: "Create an infographic",
                mediaLabel: "Infographic generation demo",
                posterAlt: "Professional JoyfulWords infographic style preview",
            },
            ppt: {
                eyebrow: "Presentation",
                title: "Generate presentations",
                description: "The complete PPT workflow is implemented in the repository. Its page entry is not open yet, so this video previews the real code flow.",
                point1: "Generate and review editable storycards first",
                point2: "Choose the theme, image style, and transitions",
                point3: "Preview and download the completed PPT",
                cta: "Coming soon · Workflow preview",
                mediaLabel: "PPT code workflow preview",
                posterAlt: "Article to presentation workflow preview",
            },
            mindmap: {
                eyebrow: "Mind Map",
                title: "Generate mind maps",
                description: "Organize complex material into a clear, editable mind map and download the result as an XMind file.",
                point1: "Extract hierarchy from long-form content",
                point2: "Drag and edit every branch",
                point3: "Save your edits and download an XMind file",
                cta: "Create a mind map",
                mediaLabel: "Mind map generation demo",
                previewLabel: "Content topic",
                previewBranchStructure: "Article structure",
                previewBranchIdeas: "Key ideas",
                previewBranchVisuals: "Visual assets",
            },
        },
        outcomes: {
            eyebrow: "Outcomes",
            title: "Give creation time ",
            titleAccent: "back to creating",
            description: "Two efficiency gains: research and write without switching platforms, then turn one article into multiple deliverables.",
            metrics: {
                platform: {
                    value: "1 platform",
                    label: "Research, write, add visuals, and export without leaving the page",
                },
                copyPaste: {
                    value: "0 copy-paste",
                    label: "Insert saved research directly instead of moving it between tools",
                },
                outputs: {
                    value: "1 → 4",
                    label: "Turn one article into an infographic, presentation, and mind map",
                },
                search: {
                    value: "Seconds",
                    label: "Search the web in real time and ground the topic immediately",
                },
            },
            pillarOne: {
                title: "Research and write without switching platforms",
                before1: "Before, research lived in three tabs while writing and visuals happened in separate tools.",
                before2: "Before, saved links disappeared into bookmarks when it was time to write.",
                after1: "Now, web search, saved material, citations, and the draft live on one editing page.",
                after2: "Now, one click moves useful material into the article without breaking focus.",
                beforeLabel: "Switching between tools",
                afterLabel: "One connected workspace",
                mediaLabel: "Before and after content workflow comparison",
            },
            pillarTwo: {
                title: "Turn one article into several deliverables",
                before1: "Before, the same content had to be rebuilt for visuals, slides, and a mind map.",
                after1: "Now, an article converts into an infographic, presentation, and mind map in one flow.",
                after2: "Now, every creation becomes reusable material for the next piece.",
                source: "Your article",
                outputInfographic: "Infographic",
                outputPpt: "Presentation",
                outputMindmap: "Mind map",
            },
            scenes: {
                creator: {
                    title: "Independent creators",
                    description: "Publish two visual-rich newsletter or blog posts in a day, with imagery and infographics ready alongside them.",
                },
                globalTeam: {
                    title: "Global content teams",
                    description: "Create Chinese and English content together, with SEO keywords and structured formatting in the workflow.",
                },
                workReport: {
                    title: "Work presentations",
                    description: "Turn a weekly report or proposal into slides and a mind map, ready to present in minutes.",
                },
            },
        },
        faq: {
            ...
            items: {
                free: {
                    question: "Is JoyfulWords free?",
                    answer: "New accounts receive 200 credits to try writing, infographics, presentations, and mind maps for free. After that, usage is pay as you go — credits are consumed dynamically based on content complexity, with no subscription fee.",
                },
                chatgpt: {
                    question: "How is this different from writing directly in ChatGPT?",
                    answer: "JoyfulWords combines web research, a reusable material library, article editing, visuals, infographics, presentations, and mind maps in one workflow. You get an editable production workspace, not only a single chat response.",
                },
                exports: {
                    question: "Which export formats are supported?",
                    answer: "Articles remain editable and publishable, infographics and mind maps can be exported as images, and presentation content can be generated as a PPT. Available formats may vary by tool.",
                },
                copyright: {
                    question: "Who owns the generated content?",
                    answer: "You can use generated results in your own creation and publishing workflow. Rights still depend on your source material, third-party licenses, and applicable law, so make sure you can use uploaded material and review the Terms of Use.",
                },
                collaboration: {
                    question: "Does JoyfulWords support team collaboration?",
                    answer: "The current product is centered on individual creation workflows, with team collaboration planned. For now, export articles, images, and presentations to share results with your team.",
                },
            },
        },
        finalCta: {
            title: "Your next piece starts here",
            description: "Create a free account and get 200 credits instantly.",
            cta: "Start creating free",
        },
        footer: {
            description: "An AI content creation workspace that turns one idea into an article, infographic, presentation, and mind map.",
            copyright: "© 2026 JoyfulWords, content creation and management tools",
            privacyPolicy: "Privacy Policy",
            termsOfUse: "Terms of Use",
            product: {
                title: "Product",
    ...
    toolsPage: {
        ...
        eyebrow: "JoyfulWords Tools",
        title: "Toolbox",
        subtitle: {
            intro: "Choose a tool and start converting, generating, or visualizing. Available tools support guest access.",
            workspacePrompt: "Need to manage articles and tasks?",
            workspaceLink: "Open your workspace",
        },
        acquisition: {
            eyebrow: "JoyfulWords Creator Toolbox",
            headlinePrimary: "Turn content into",
            headlineAccent: "finished work",
            description: "Convert documents, build presentations, create visuals, and chart data. Use available tools as a guest.",
            primaryAction: "Convert to Word free",
            primaryHint: "Guest access · Download DOCX",
            secondaryAction: "View all 6 tools",
            heroAlt: "A creator scene where paper content becomes presentations, images, and charts",
            demoLabel: "A complete content-to-output demo",
            demoCaption: "See one source become a presentation, infographic, and editable document",
            demoDuration: "Play · Understand it in 60 seconds",
            benefitsLabel: "Toolbox benefits",
            benefits: {
                guest: {
                    title: "Start as a guest",
                    description: "Open tools need no registration",
                },
                editable: {
                    title: "Keep editing results",
                    description: "Word, PPTX, and image exports",
                },
                workflow: {
                    title: "One place to finish",
                    description: "From content to deliverable",
                },
            },
        },
        showcase: {
            eyebrow: "Real product demos",
            title: "See the result, then choose a tool",
            description: "Every demo maps to a real tool. Preview the workflow and output, then start immediately.",
            visualAlt: "A creator scene where paper content unfolds into finished visual work",
            dataAlt: "A creator scene where paper data becomes clear charts",
        },
        toolActions: {
            "ai-writer": "Start writing",
            "image-generator": "Create an image free",
            infographic: "Generate an infographic",
            "mind-map": "Generate a mind map",
            "ai-charts": "Generate an AI chart",
            "ppt-generator": "Generate a PPT",
            "markdown-to-word": "Convert to Word free",
            "ppt-to-word": "Extract to Word",
            "word-to-ppt": "Generate a PPT",
            "meme-inserter": "Find a meme",
        },
        directory: {
            title: "Choose a task and start",
            description: "Convert documents, create images and presentations, or turn data into charts. Each tool works on its own.",
        },
        status: "Coming soon",
        ...
        tools: {
            ...
            "image-generator": {
                title: "Create Image",
                description: "Describe what you need and generate covers, supporting images, or campaign assets. Guests can create 3 images per day.",
                category: "Visual assets",
                meta: "Create Image",
            },
            infographic: {
                title: "Infographic",
                description: "Paste takeaways, steps, or data and turn them into a shareable infographic.",
            ...
            "ai-charts": {
                title: "AI Charts",
                description: "Enter data, claims, or analysis and generate readable charts for reports and retrospectives.",
                category: "Data storytelling",
                meta: "Chart generation",
            },
            "ppt-generator": {
                title: "PPT Generator",
                description: "Paste Markdown or choose an article, review the structure and template, then export an editable PPTX.",
                category: "Presentation",
                meta: "Article to PPTX",
            },
            "markdown-to-word": {
                title: "Markdown to Word",
                description: "Paste Markdown, choose a document template, and download an editable DOCX. Guest access is available.",
                category: "Document conversion",
                meta: "MD to DOCX",
            },
            "ppt-to-word": {
                title: "PPT to Word",
                description: "Upload a PPTX and extract titles, body content, and speaker notes into a Word document.",
                category: "Document conversion",
                meta: "PPTX to DOCX",
            },
            "word-to-ppt": {
        ...
        aiCharts: {
            ...
            generationFailed: "Chart generation failed. Please try again later.",
            generationTimeout: "Chart generation timed out. Please try again later.",
        ...
        pptGenerator: {
            title: "PPT Generator",
            description: "Paste Markdown or choose an article, review the content structure, then continue to Storycard and template selection.",
            authLoading: "Checking your session",
            loginTitle: "Sign in to generate a PPT",
            loginDescription: "PPT generation uses your account credits. Sign in to paste Markdown or choose an article and continue the existing workflow.",
            loginAction: "Sign in to continue",
            workflowLabel: "PPT generation workflow",
            workflowInput: "Markdown",
            workflowReview: "Review structure",
            workflowExport: "PPTX",
            loadingArticles: "Loading articles",
            loadError: "Articles could not be loaded. Please try again.",
            retry: "Retry",
            emptyTitle: "No articles are ready for PPT generation",
            emptyDescription: "Create an article with body content, then return here to generate a PPT.",
            createArticle: "Open article workspace",
            sourceLabel: "Content source",
            sourceDescription: "Enter Markdown directly or reuse content from your article workspace.",
            sourcePaste: "Paste Markdown",
            sourceArticle: "Choose an article",
            pasteTitleLabel: "Article title (optional)",
            pasteTitlePlaceholder: "The first content line will be used if left blank",
            pasteContentLabel: "Markdown content",
            pasteContentPlaceholder: "# Presentation title\n\nPaste Markdown here. Lists, tables, quotes, and code blocks are supported.",
            workspaceLabel: "Markdown workspace",
            charCount: "{count} characters",
            viewLabel: "Markdown display mode",
            viewEdit: "Edit",
            viewPreview: "Preview",
            viewSplit: "Split",
            ...
            previewEmptyDescription: "Start typing Markdown to render headings, lists, tables, and quotes in real time.",
            markdownHint: "Supports GFM headings, lists, task lists, tables, quotes, code blocks, and links.",
            pasteHint: "Markdown is converted and saved as article content before the Storycard and PPT workflow begins.",
            pasteContentRequired: "Enter the Markdown content you want to turn into a PPT.",
            prepareError: "The Markdown content could not be saved. Please try again.",
            preparing: "Preparing content",
            articleModeTitle: "Start from an existing article",
            articleModeDescription: "Choose an article with body content that is not archived, then continue the existing Storycard and PPT workflow.",
            articleLabel: "Choose an article",
            articlePlaceholder: "Select an article",
            articleHint: "Only articles with body content that are not archived are shown.",
            untitledArticle: "Untitled article",
            start: "Generate PPT",
            viewProgress: "View generation progress",
            progressTitle: "PPT task is running in the background",
            progressDescription: "Closing the dialog does not stop the task. Return here anytime to check its current step.",
        },
        tasks: {
            title: "Task List",
        ...
        detail: {
            back: "Back to tools",
            pptTitle: "Generate a PPT from an article",
            pptDescription: "PPT generation starts from a saved JoyfulWords article. Open the article workspace, confirm the Storycard and template, then generate the deck.",
            pptAction: "Open article workspace",
    ...
    billing: {
        ...
        payment: {
            ...
            checkoutWaiting: {
                stillCreating: "Your payment page is still being prepared",
                cancelNotice: "You can keep waiting or cancel this action.",
                cancel: "Cancel",
            },
            createFailed: {
                eyebrow: "Not ready yet",
                title: "We couldn't open the payment page",
                description: "Please try again later or return to Billing.",
                loadFailed: "We couldn't load this payment. Return to Billing and try again.",
                loading: "Loading...",
                credits: "Recharge credits",
                creditsValue: "{credits} credits",
                retryNotice: "We'll prepare the payment page again when you retry.",
                retry: "Try Again",
