...
test("select latest published style mapping without mutating catalog", () => {
 const templates = [1,3,2].map(version => ({id: version, name_i18n: {zh:"简约商务",en:"Minimal business"}, description_i18n: {zh:"模板",en:"Template"}, cover_url: "", template_key:"minimal-business",version,metadata:{style_slug:"minimal-business"}} as PPTTemplate))
